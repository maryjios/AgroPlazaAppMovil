...
public class AdapterServicios extends RecyclerView.Adapter<AdapterServicios.ViewHolderDatos> implements View.OnClickListener {

    ArrayList<Descuentos> ListarServicios; //listaDatos
    private View.OnClickListener listener;
    public AdapterServicios(ArrayList<Descuentos> listaDatos) {
    ...
    public ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_servicios,null, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
        holder.asignarDatos(ListarServicios.get(position));
    }
